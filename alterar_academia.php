...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="alterar_academia_db.php" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="telefone" class="form-control" id="telefone" value="<?php echo $item['telefone'];?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cnpj" class="form-control" id="cnpj" value="<?php echo $item['cnpj'];?>">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-success">Alterar academia</button>
                </form>
            </div>
        </div>
    </div>
