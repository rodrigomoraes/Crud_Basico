...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-1">
            <a href="listar_instrutores.php" class="btn btn-dark">Voltar</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <form action="alterar_instrutor_db.php" method="post">
                ...
                <button type="submit" class="btn btn-success">Alterar Instrutor</button>
            </form>
        </div>
    </div>
</div>
